...
class TestChat:
    ...
    def test_handle_chat_commands_should_accept_an_exit_string_and_perform_a_system_exit(self, setup_teardown):
        chat_session = setup_teardown
        with pytest.raises(SystemExit):
            chat_session._handle_chat_commands(user_input="exit")
        assert True

    def test_handle_chat_commands_should_accept_an_empty_string_and_not_perform_a_system_exit(self, setup_teardown):
        chat_session = setup_teardown

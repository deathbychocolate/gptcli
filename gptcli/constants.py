...
GPTCLI_PROVIDER_OPENAI_STORAGE_CHAT_DIR: str = os.path.join(GPTCLI_PROVIDER_OPENAI_STORAGE_DIR, "chat")
...
OPENAI_API_KEY: str = "DBC_GPTCLI_OPENAI_API_KEY"  # CI/test-only: env var name for integration tests.
...
GPTCLI_PROVIDER_MISTRAL_STORAGE_CHAT_DIR: str = os.path.join(GPTCLI_PROVIDER_MISTRAL_STORAGE_DIR, "chat")
...
MISTRAL_API_KEY: str = "DBC_GPTCLI_MISTRAL_API_KEY"  # CI/test-only: env var name for integration tests.
